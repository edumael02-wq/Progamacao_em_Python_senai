...
# raquete1_y, raquete1_x = 50,225
# raquete2_y, raquete2_x = 450,225

# largura_raquete, altura_raquete = 20,100

# bola_x, bola_y = 250, 250
# largura_bola, altura_bola = 5,5

# velocidade_bola_x = 0.2
...
#     pygame.draw.rect(janela, verde, (raquete1_x, raquete1_y, largura_raquete, altura_raquete ) ) 
#     pygame.draw.rect(janela, verde, (raquete2_x, raquete2_y, largura_raquete, altura_raquete ) ) 
#     pygame.draw.ellipse(janela, verde, (bola_x, bola_y, largura_bola, altura_bola ) ) 
#     placar_text = font.render (f '{placar} | {placar2}', True, verde)
#     janela.blit(placar_text, (180,20))

# run = True

# while run == True:
#      for eventos in pygame.events.get():
...
# # impedir que ela saia da tela no eixo y 
#     if bola_y <= 0 and bola_y > 500 -altura_bola:
#        velocidade_bola_y = -velocidade_bola_y

#     if (raquete1_x < bola_x < raquete1_x) and ( raquete1_y < bola_y < raquete1_y)
...
#     if(raquete1_x < bola_x < raquete1_x + raquete1_x) and (raquete1_y < bola_y + raquete1_y):
#         velocidade_bola_x = - velocidade_bola_x
#     if (raquete2_x < bola_x < raquete2_x + raquete2_x) and (raquete2_y < bola_y < raquete2_y + raquete2_y):
...
while run == True:
    ...
    keys  =  pygame.key.get_pressed() 
    if keys[pygame.K_s] and raquete1_y > 0:
        raquete1_y -= velocidade_raquete
    if keys[pygame.K_x] and raquete1_y < 500 - altura_raquete:
        raquete1_y += velocidade_raquete    
